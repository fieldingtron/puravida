...
description: "Half-day adventure through the Sacred Valley"
dates: "All year"
...
highlights:
  - "Experience exciting Class II-III rapids suitable for beginners and experienced rafters."
  - "Enjoy spectacular views of the Sacred Valley and mountain ranges."
  - "View archaeological remains and Inca terraces at Ollantaytambo."
  - "Observe local villagers working on their crops, fishermen, and Andean wild birds."
  - "Perfect introduction to whitewater rafting for all skill levels."
additionalDetails:
  - "Accessible Location: Just a short drive from Cusco, the historical capital of Peru."
  - "Cultural Experience: Raft through the Sacred Valley with views of ancient Inca ruins."
  - "Professional Guides: English-speaking guides with swift water rescue training."
  - "Beginner-Friendly: Suitable for first-time rafters with no experience necessary."
